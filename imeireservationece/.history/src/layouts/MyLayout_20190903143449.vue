  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated class="bg-primary text-black text-bold" height-hint="98">
      <q-toolbar>
        ...
        <div><q-btn label="Back to brodosnet" type="submit" color="secondary no-shadow" @click="logout()"></q-btn></div>
        </q-toolbar>
...
export default {
  ...
  methods: {
    openURL,
    logout() {
    this.$axios.get("http://stockdevvm.brodos.net:8181/wms/isaac/logout")
        .then(
