...
export default {
  ...
  methods: {
    onSubmit () {
      let obj = new Object();
      obj.articleNumber = this.articleNo;
      obj.customerNumber = 1234;
      obj.email = this.customerEmail;
      obj.quantity = this.quantity;
      obj.reservationComment = this.reservationComment;

      this.$axios.post('/wms/serialnumberreservation', obj)
        .then(response => {
