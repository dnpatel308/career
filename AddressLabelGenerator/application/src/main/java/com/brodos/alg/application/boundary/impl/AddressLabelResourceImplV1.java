...
import com.brodos.alg.application.boundary.AddressLabelResourceV1;
 ...
 */
@Singleton
@Named("addressLabelResourcev1")
public class AddressLabelResourceImplV1 implements AddressLabelResourceV1 {
