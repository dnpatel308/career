 ...
 * @author padhaval
 */
public interface AddressLabelRepository {
    ...
    public AddressLabel checkAddressLabelExistForTrackingCodeOrNot(String freightForwarder, String trackingCode, String formatType);        
}
